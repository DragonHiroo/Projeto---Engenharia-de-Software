...
class relatorio extends Model
{
    ...
    public static function relatorio_pacientesMedico() {
    ...
    public static function relatorio_pacientesEspecialidade() {
    ...
    public static function relatorio_cirurgiaMedico() {
    ...
    public static function relatorio_media_cirurgiaMedico() {
