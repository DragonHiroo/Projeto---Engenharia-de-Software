        ...
        <div class="row">
                ...
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active text-white" style="background-color: #067F6E;" href="busca_enfermeiros.php">
                                    <!-- span data-feather="file-text"></span-->
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Busca por enfermeiros</h1>
            ...
            This week
                ...
                <form class="form-inline md-form form-sm active-cyan-2 mt-2">
                    <input class="form-control form-control-sm mr-3 w-75" type="text" placeholder="Digite o nome do(a) enfermeiro(a)..." aria-label="Search">
