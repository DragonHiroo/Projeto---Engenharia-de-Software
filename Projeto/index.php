...
<html lang="en">
  <head>
    ...
    <title>Dashboard - Cirurgia</title>
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="#">
              <span data-feather="home"></span> Cirurgia <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              ...
              busca Cirurgia por data
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
              <span data-feather="layers"></span>
              Busca cirurgia por Especialidade
            </a>
          </li>
        </ul>
